...
function leetSpeak($str){
    ...
    for($i=0; isset($str[$i]); $i++){
        ...
        elseif ($str[$i] == 'S' || $str[$i] == 't'){
            $str[$i] = '5';   

        }

        elseif ($str[$i] == 'T' || $str[$i] == 'g'){
            $str[$i] = '7';   
    ...
    return $str;  //Be carefull!  Return has to be outside of the loop but inside the function, otherwise it will not function.
    
}

echo leetSpeak('Nowadays people know the price of everything and the value of nothing.'); // We can use any string here.
